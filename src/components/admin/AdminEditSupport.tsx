...
export type AdminEditorTab = "page" | "features" | "fields" | "custom" | "publish";
...
export function activePatternsPage(): LayoutPageId {
...
export function adminPageFromPath(pathname: string): LayoutPageId | null {
...
export function adminPageSurface(page: LayoutPageId | null): RegistrySurface {
