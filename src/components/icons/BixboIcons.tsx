...
import { BixboConnectIcon, BrainIcon } from "./BixboBrandIcons";

export { BixboConnectIcon, BrainIcon };
...
export const BixboConnect = BixboConnectIcon;
