    ...
    <div className="pdf-report-root px-4 pb-28 pt-3 lg:px-0">
      <div className="pdf-controls pdf-no-print">
        <section className="rounded-3xl bg-surface p-4 shadow-sm ring-1 ring-border/80">
          ...
          <button type="button" onClick={() => window.print()} className="mt-4 h-11 w-full rounded-2xl bg-primary text-sm font-semibold text-primary-foreground">{t("Save / Print PDF")}</button>
        </section>
      </div>
