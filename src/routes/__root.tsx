...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BIXBO — sleduj periódu, bolesť, lieky a poznámky v krásnom jednoduchom denníku." },
      { name: "author", content: "BIXBO" },
      { property: "og:title", content: "BIXBO — Denník zdravia" },
      { property: "og:description", content: "Sleduj periódu, bolesť, lieky a poznámky v krásnom jednoduchom denníku." },
