 ...
 * rows. Safari owns focused-field scrolling. Feeding dynamic keyboard viewport
 * height/offset back into the sheet creates a resize/reposition loop that makes
 * text entry jump and stutter.
 *
 * The legacy hook name is retained to keep the logging API stable. This module
 * intentionally does not subscribe to keyboard viewport geometry anymore.
 */
 ...
 * iOS remains free to pan its visible viewport around the focused native input.
 */
 ...
 * No keyboard-geometry, focus, resize or scroll listeners are installed here.
 */
