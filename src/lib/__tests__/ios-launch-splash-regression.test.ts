...
describe("iPhone PWA launch presentation", () => {
  it("shows the current BIXBO penguin for one second on each real standalone document launch", () => {
    ...
    expect(root).toContain('src="/bixbo-mascot-user.png?v=20260816-launch2"');
