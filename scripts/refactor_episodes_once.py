...
rep(
    ...
    "episode chooser renderer",
)

start = s.index("/* ------------------- PANIC attack ------------------- */")
end = s.index("/* ------------------- PERIOD (Blueberry) ------------------- */")
replacement = r'''/* ------------------- EPISODE wizard primitives ------------------- */
...
path.write_text(s)
print("Episodes refactor applied")
